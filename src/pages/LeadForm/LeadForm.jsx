...
const LeadForm = () => {
    ...
    useEffect(() => {
        updateDeadline(startDate, endDate);
    }, [startDate, endDate]);
                    ...
                    <form onSubmit={handleSubmit}>
                        ...
                        <div className={styles.numCountryBox}>
                            <div className={styles.nameDiv}>
                                ...
                                <input type='text' placeholder='Phone Number' className={styles.name} onChange={handleChange} value={val.number} name='number' />
                            </div>
                        ...
                        <div className={styles.submitForm}>
                            <div className={styles.btn}>
                                <input type='submit' value={"Get a quate in multiple spaces"} className={styles.inputBtn} />
                            </div>
                        </div>
                    </form>
                </div>
