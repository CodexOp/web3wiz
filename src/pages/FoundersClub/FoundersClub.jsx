...
const items = [
    ...
    {
        title: `Is this just another networking group?`, content: `Far from it. While networking is a component, we delve deeper into the nuts and bolts Of running a web3 business,
...
const FoundersClub = () => {
    ...
    return (
        <div style={{ overflow: "hidden", position: "relative", zIndex: "2" }} className='mainContainerFounder'>
            <Navbar />
            <FounderHero />
            <HowWork />
